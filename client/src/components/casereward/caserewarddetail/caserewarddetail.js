            ...
            <div className='left-top' >
             ...
             >
                <List>
                    ...
                    <Item className='item'>
                        <span className='prod-title'>案件结果：</span>
                        <span>经民警以及民众审核，该案件为诈骗案件</span>
                    </Item>
                    <Item className='item'>
                        ...
                        <Steps>
                          ...
                          <Step status="finish" title="辖区民警审核"  />
                          <Step status="finish" title="案件公布通知"  />
                          <Step status="finish" title="案件完成" icon={<SmileOutlined />} />
                        </Steps>
                    </Item>
