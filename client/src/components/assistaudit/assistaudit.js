                ...
                <div className='assistaudit_all'>
                    {
                        dataList.map((item)=>{//箭头函数
                            ...
                            <div className='right_title'>
                                <a href={`/admin/assistaudit_about/${item.id}`}><span>{item.title}</span></a>
                            </div>
                            <div className='right_describe'>
                            <a href={`/admin/assistaudit_about/${item.id}`}><span>{item.describe}</span></a>
                            </div>
                            <div className='right_bottom'>
                                ...
                                <svg className="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="15" height="15">
                                    ...
                                    {comment.isShow ? comment.id === item.id ? <div>评论</div>: null:null}
                    ...
                    <div className='line'></div>
                        <div className='assistaudit_left'>
                            <a href="/admin/assistaudit_about/index">
                        ...
                        <div className='assistaudit_right'>
                            <div className='right_title'>
                                <a href='/admin/assistaudit_about/index'><span>电信网络诈骗</span></a>
                            </div>
                            <div className='right_describe'>
                            <a href='/admin/assistaudit_about/index'><span>点击诈骗短信不明链接，填写个人信息，银行卡账户余额被转移,点击诈骗短信不明链接，填写个人信息，银行卡账户余额被转移,点击诈骗短信不明链接，填写个人信息，银行卡账户余额被转移</span></a>
                            </div>
                            <div className='right_bottom'>
